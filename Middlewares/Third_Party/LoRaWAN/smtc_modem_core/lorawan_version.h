...
#define LORAWAN_VERSION_MAIN   (0x01U) /*!< [31:24] main version */
#define LORAWAN_VERSION_SUB1   (0x00U) /*!< [23:16] sub1 version */
#define LORAWAN_VERSION_SUB2   (0x02U) /*!< [15:8]  sub2 version */
