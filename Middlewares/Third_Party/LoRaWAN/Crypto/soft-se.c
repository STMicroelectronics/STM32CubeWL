...
#endif /* CONTEXT_MANAGEMENT_ENABLED == 0 */
#endif /* LORAWAN_KMS */
...
SecureElementStatus_t SecureElementInit( SecureElementNvmData_t *nvm, SecureElementGetUniqueId seGetUniqueId )
{
    ...
    memcpy1((uint8_t *)SeNvm->DevEui, seNvmInit.DevEui, SE_EUI_SIZE);
    memcpy1((uint8_t *)SeNvm->JoinEui, seNvmInit.JoinEui , SE_EUI_SIZE);
