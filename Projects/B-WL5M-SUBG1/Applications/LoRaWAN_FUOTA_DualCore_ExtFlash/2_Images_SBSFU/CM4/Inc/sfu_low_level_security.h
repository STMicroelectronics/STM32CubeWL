...
/**
  ...
  *                   from 0x08000000 ==> 0x08005FFF (24 Kbytes)
  */
...
#define SFU_PROTECT_MPU_FLASHEXE_SREG  0xC0U               /*!< 32 Kbytes / 8 * 6 ==> 24 Kbytes */
...
/**
  ...
  *                   Read only capability configured
  *                   In addition to region 2, from 0x08006000 ==> 0x080067FF (2 Kbytes)
  */
#define SFU_PROTECT_MPU_FLASHEXE_ADJUST_RGNV  MPU_REGION_NUMBER3
#define SFU_PROTECT_MPU_FLASHEXE_ADJUST_START 0x08006000UL
...
/**
  ...
  *                   From 0x08008000 ==> 0x08013FFF (48 kbytes)
  */
#define SFU_PROTECT_MPU_APP_FLASHEXE_RGNV  MPU_REGION_NUMBER4
#define SFU_PROTECT_MPU_APP_FLASHEXE_START FLASH_BASE
#define SFU_PROTECT_MPU_APP_FLASHEXE_SIZE  MPU_REGION_SIZE_128KB
#define SFU_PROTECT_MPU_APP_FLASHEXE_SREG  0xE3U           /*!< 128 Kbytes / 8 * 3 ==> 48 Kbytes */
...
/**
  ...
  *                   In addition to region 4, from 0x08007000 ==> 0x08007FFF (4 kbytes)
  */
#define SFU_PROTECT_MPU_APP_FLASHEXE_ADJUST_RGNV  MPU_REGION_NUMBER5
#define SFU_PROTECT_MPU_APP_FLASHEXE_ADJUST_START 0x08007000UL
#define SFU_PROTECT_MPU_APP_FLASHEXE_ADJUST_SIZE  MPU_REGION_SIZE_4KB
#define SFU_PROTECT_MPU_APP_FLASHEXE_ADJUST_SREG  0x00U    /*!< 4 Kbytes / 8 * 8 ==> 4 Kbytes */
...
#define APP_PROTECT_MPU_FLASHEXE_SIZE  MPU_REGION_SIZE_128KB
#define APP_PROTECT_MPU_FLASHEXE_SREG  0xE3U           /*!< 128 Kbytes / 8 * 3==> 48 Kbytes */
...
#define APP_PROTECT_MPU_FLASHEXE_ADJUST_START 0x08007000UL
#define APP_PROTECT_MPU_FLASHEXE_ADJUST_SIZE  MPU_REGION_SIZE_4KB
#define APP_PROTECT_MPU_FLASHEXE_ADJUST_SREG  0x00U    /*!< 4 Kbytes / 8 * 8 ==> 4 Kbytes */
