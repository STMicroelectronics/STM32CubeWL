...
typedef enum
{
  ...
  SFU_STATE_ROLLBACK_PREV_USER_FW,      /*!< rollback with previous firmware                      */
...
char *m_aStateMachineStrings[] = { "Checking Status on Reset.",
                                   ...
                                   "Rollback with previous Fw Image.",
...
#define IS_SFU_SM_STATE(STATE)  (((STATE) == (uint8_t)SFU_STATE_CHECK_STATUS_ON_RESET)    || \
                                 ...
                                 ((STATE) == (uint8_t)SFU_STATE_INSTALL_NEW_USER_FW)      || \
                                 ...
                                 ((STATE) == (uint8_t)SFU_STATE_RESUME_INSTALL_NEW_USER_FW)|| \
                                 ((STATE) == (uint8_t)SFU_STATE_ROLLBACK_PREV_USER_FW)|| \
