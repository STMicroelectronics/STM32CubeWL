/**
  ...
  @verbatim
  ******************************************************************************
  * @file    Applications/LoRaWAN_FUOTA_DualCore_ExtFlash/LoRaWAN_End_Node_DualCore/readme.txt
...
@par Directory contents
  ...
  - LoRaWAN_End_Node_DualCore/CM4/MbMux/radio_mbwrapper.h                       This file implements the CM4 side wrapper of the Radio interface
                                                                                shared between M0 and M4.
  - LoRaWAN_End_Node_DualCore/Common/Board/b_wl5m_subg_conf.h                   B-WL5M-SUBG board configuration file.
  - LoRaWAN_End_Node_DualCore/Common/Board/mx25l4006_conf.h                     This file contains all the description of the
  ...
  - LoRaWAN_End_Node_DualCore/CM0PLUS/LoRaWAN/App/fw_update_agent.c             This file provides set of functions to manage Firmware Update functionalities.
  - LoRaWAN_End_Node_DualCore/CM0PLUS/LoRaWAN/App/lora_app.c                    Application of the LRWAN Middleware
  - LoRaWAN_End_Node_DualCore/CM0PLUS/LoRaWAN/Target/frag_decoder_if.c          Implements the interface of LoRa-Alliance fragmentation decoder
...
@par Hardware and Software environment
  ...
  - Configure the software via the configuration files:
    ...
    - CM4 (Lora application)
        - sys_conf.h, lora_app.c, lora_app.h, main.h, etc
    - Careful:
