...
download area also located in internal flash. Each image has its own keys for signature verification and firmware encryption.
...
@par Hardware and Software environment
   ...
   - This example has been tested with B-WL5M-SUBG board and can be easily tailored to any other supported device and
     development board.
