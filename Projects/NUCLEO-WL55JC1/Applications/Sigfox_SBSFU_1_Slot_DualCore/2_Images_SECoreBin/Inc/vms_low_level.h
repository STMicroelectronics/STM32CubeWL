 ...
 * Storage has been defined in the mapping from 0x2000C400 to 0x2000CCFF to reserve area
 */
#define VMS_KMS_DATA_STORAGE_START (0x2000C400UL)
#define VMS_KMS_DATA_STORAGE_END   (0x2000CCFFUL)
