...
/**
  ...
  *                   from 0x08000000 ==> 0x080027FF (10 Kbytes)
  */
#define SFU_PROTECT_MPU_FLASHEXE_RGNV  MPU_REGION_NUMBER2
#define SFU_PROTECT_MPU_FLASHEXE_START M4_SB_REGION_ROM_START
#define SFU_PROTECT_MPU_FLASHEXE_SIZE  MPU_REGION_SIZE_16KB
#define SFU_PROTECT_MPU_FLASHEXE_SREG  0xE0U    /*!< 16 Kbytes / 8 * 5 ==> 10 Kbytes */
...
#define APP_PROTECT_MPU_FLASHEXE_START SLOT_ACTIVE_2_START
#define APP_PROTECT_MPU_FLASHEXE_SIZE  MPU_REGION_SIZE_4KB
