...
/**
  * @brief Region 4 - Enable the read/write operations for the EE DataStorage in unprivileged mode.
  *                   Read/write capability configured
  *                   Execution capability disabled
  *                   From 0x0802A000U ==>  0x0802AFFF (4 kbytes)
  */
#define APP_PROTECT_MPU_EE_RGNV  MPU_REGION_NUMBER4
#define APP_PROTECT_MPU_EE_START EE_DATASTORAGE_START
#define APP_PROTECT_MPU_EE_SIZE  MPU_REGION_SIZE_4KB
#define APP_PROTECT_MPU_EE_SREG  0x00U               /*!< All subregions activated */
#define APP_PROTECT_MPU_EE_PERM  MPU_REGION_FULL_ACCESS
#define APP_PROTECT_MPU_EE_EXECV MPU_INSTRUCTION_ACCESS_DISABLE
#define APP_PROTECT_MPU_EE_TEXV  MPU_TEX_LEVEL0
#define APP_PROTECT_MPU_EE_B     MPU_ACCESS_BUFFERABLE
#define APP_PROTECT_MPU_EE_C     MPU_ACCESS_NOT_CACHEABLE
