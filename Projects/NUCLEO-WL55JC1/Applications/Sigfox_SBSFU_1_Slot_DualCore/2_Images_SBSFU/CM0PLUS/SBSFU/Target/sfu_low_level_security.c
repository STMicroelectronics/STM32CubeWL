...
SFU_ErrorStatus SFU_LL_SECU_SetProtectionMPU_UserApp(void)
{
  ...
  /* Enable read/write rights for EE area */
  MPU_InitStruct.Enable               = MPU_REGION_ENABLE;
  MPU_InitStruct.Number               = APP_PROTECT_MPU_EE_RGNV;
  MPU_InitStruct.BaseAddress          = APP_PROTECT_MPU_EE_START;
  MPU_InitStruct.Size                 = APP_PROTECT_MPU_EE_SIZE;
  MPU_InitStruct.SubRegionDisable     = APP_PROTECT_MPU_EE_SREG;
  MPU_InitStruct.AccessPermission     = APP_PROTECT_MPU_EE_PERM;
  MPU_InitStruct.DisableExec          = APP_PROTECT_MPU_EE_EXECV;
  MPU_InitStruct.IsShareable          = MPU_ACCESS_NOT_SHAREABLE;
  MPU_InitStruct.IsBufferable         = APP_PROTECT_MPU_EE_B ;
  MPU_InitStruct.IsCacheable          = APP_PROTECT_MPU_EE_C;
  MPU_InitStruct.TypeExtField         = APP_PROTECT_MPU_EE_TEXV;
  HAL_MPU_ConfigRegion(&MPU_InitStruct);
