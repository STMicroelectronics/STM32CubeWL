...
/**
  ...
  * @brief   This sample code shows how to use STM32WLxx RTC LL API
...
static void MX_RTC_Init(void)
{
  ...
  */
  ...
  NVIC_SetPriority(TAMP_STAMP_LSECSS_SSRU_IRQn, 0x0F);
  NVIC_EnableIRQ(TAMP_STAMP_LSECSS_SSRU_IRQn);
