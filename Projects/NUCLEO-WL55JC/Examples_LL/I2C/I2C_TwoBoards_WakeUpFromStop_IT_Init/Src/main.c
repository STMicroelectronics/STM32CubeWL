...
static void MX_I2C2_Init(void)
{
  ...
  */
  ...
  I2C_InitStruct.Timing = 0x00300719;
  ...
  LL_I2C_EnableWakeUpFromStop(I2C2);
  /* Unmask wakeup with Interrupt request from I2C2 */
  LL_EXTI_EnableIT_0_31(LL_EXTI_LINE_24);

  /*Enable I2C2 address match/error interrupts:
...
#else /* MASTER_BOARD */
  /* Enable I2C2 transfer complete/error interrupts:
