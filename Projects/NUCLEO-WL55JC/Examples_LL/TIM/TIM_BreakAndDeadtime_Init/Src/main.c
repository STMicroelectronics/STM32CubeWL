...
static void MX_TIM1_Init(void)
{
  ...
  uint32_t Prescaler = __LL_TIM_CALC_PSC(SystemCoreClock, 10000000);
  uint32_t Period = __LL_TIM_CALC_ARR(SystemCoreClock, Prescaler, 100*2);
  uint32_t Pulse1 = (Period * 500) / 1000;
  uint32_t Pulse2 = (Period * 250) / 1000;
  uint32_t Pulse3 = (Period * 125) / 1000;
  uint32_t Deadtime = __LL_TIM_CALC_DEADTIME(SystemCoreClock, LL_TIM_CLOCKDIVISION_DIV1, 4000);
  ...
  */
  ...
  TIM_OC_InitStruct.CompareValue = Pulse1;
  ...
  TIM_OC_InitStruct.CompareValue = Pulse2;
  LL_TIM_OC_Init(TIM1, LL_TIM_CHANNEL_CH2, &TIM_OC_InitStruct);
  LL_TIM_OC_DisableFast(TIM1, LL_TIM_CHANNEL_CH2);
  LL_TIM_OC_EnablePreload(TIM1, LL_TIM_CHANNEL_CH3);
  TIM_OC_InitStruct.CompareValue = Pulse3;
  ...
  */
  ...
  GPIO_InitStruct.Pin = LL_GPIO_PIN_10|LL_GPIO_PIN_9|LL_GPIO_PIN_7|LL_GPIO_PIN_8;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ALTERNATE;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_HIGH;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
