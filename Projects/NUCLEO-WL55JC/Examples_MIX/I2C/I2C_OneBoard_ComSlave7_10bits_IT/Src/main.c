...
/**
  ...
  * @brief   This sample code shows how to use STM32WLxx I2C HAL and LL API
...
int main(void)
{
  ...
  /* Wait for User push-button (B1) press before starting the Communication with Slave2 */
  while (BSP_PB_GetState(BUTTON_SW1) != GPIO_PIN_RESET)
  {
  }
  
  /* Wait for User push-button (B1) release before starting the Communication with Slave2 */
  while (BSP_PB_GetState(BUTTON_SW1) != GPIO_PIN_SET)
  {
  }
