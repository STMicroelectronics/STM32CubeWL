...
@par Directory contents
   ...
   - 1_Image_UserApp/Src/sfu_app_new_image.c      Manage the new firmware image storage and installation
   ...
   - 1_Image_UserApp/Inc/sfu_app_new_image.h      Header file for sfu_app_new_image.c
...
This postbuild script:
 ...
 - prepares the new portion of firmware image: part of firmware image which changed vs a reference firmware image.
   ...
   application into RefUserApp.bin (in folder 1_Image_UserApp/IDE).
   ...
   the reference binary file and a PartialUserApp.sfb will be generated in 1_Image_UserApp_M0Plus/Binary folder.
