 ...
 * Storage has been defined into mapping from 0x0803E000 to 0x0803FFFF to reserve area
 */
#define NVMS_LL_BLOCK0_ADDRESS   (0x0803E000UL)
#define NVMS_LL_BLOCK1_ADDRESS   (0x0803F000UL)
