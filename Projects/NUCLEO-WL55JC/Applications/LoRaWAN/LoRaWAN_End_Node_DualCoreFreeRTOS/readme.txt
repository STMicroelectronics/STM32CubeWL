...
@par Directory contents 
  ...
  - LoRaWAN_End_Node_DualCoreFreeRTOS/CM0PLUS/MbMux/mbmuxif_kms.h               Interface layer CM4 Kms to MBMUX (Mailbox Multiplexer)
  - LoRaWAN_End_Node_DualCoreFreeRTOS/CM0PLUS/MbMux/mbmuxif_lora.h              API provided to CM0PLUS applic to register and handle LoraWAN via MBMUX
  - LoRaWAN_End_Node_DualCoreFreeRTOS/CM0PLUS/MbMux/mbmuxif_radio.h             API for CM0PLUS applic to register and handle RADIO driver via MBMUX
  - LoRaWAN_End_Node_DualCoreFreeRTOS/CM0PLUS/MbMux/mbmuxif_sys.h               API for CM0PLUS applic to handle the SYSTEM MBMUX channel
  - LoRaWAN_End_Node_DualCoreFreeRTOS/CM0PLUS/MbMux/mbmuxif_trace.h             API for CM0PLUS applic to register and handle TRACE via MBMUX
  ...
  - LoRaWAN_End_Node_DualCoreFreeRTOS/CM4/MbMux/mbmuxif_kms.h                   Interface layer CM4 Kms to MBMUX (Mailbox Multiplexer)
  - LoRaWAN_End_Node_DualCoreFreeRTOS/CM4/MbMux/mbmuxif_lora.h                  API provided to CM4 applic to register and handle LoraWAN via MBMUX
  - LoRaWAN_End_Node_DualCoreFreeRTOS/CM4/MbMux/mbmuxif_radio.h                 API for CM4 applic to register and handle RADIO driver via MBMUX
  - LoRaWAN_End_Node_DualCoreFreeRTOS/CM4/MbMux/mbmuxif_sys.h                   API for CM4 applic to handle the SYSTEM MBMUX channel
  - LoRaWAN_End_Node_DualCoreFreeRTOS/CM4/MbMux/mbmuxif_trace.h                 API for CM4 applic to register and handle TRACE via MBMUX
  - LoRaWAN_End_Node_DualCoreFreeRTOS/CM4/MbMux/radio_mbwrapper.h               This file implements the CM4 side wrapper of the Radio interface
                                                                                shared between M0 and M4.
  - LoRaWAN_End_Node_DualCoreFreeRTOS/Common/Board/board_resources.h            Header for driver at.c module
  ...
  - LoRaWAN_End_Node_DualCoreFreeRTOS/CM0PLUS/Core/Src/ipcc_if.c                Interface to IPCC: handles IRQs and abstract appl from Ipcc handler and ch direction
  ...
  - LoRaWAN_End_Node_DualCoreFreeRTOS/CM0PLUS/MbMux/mbmuxif_kms.c               Interface layer CM0PLUS Kms to MBMUX (Mailbox Multiplexer)
  - LoRaWAN_End_Node_DualCoreFreeRTOS/CM0PLUS/MbMux/mbmuxif_lora.c              allows CM0 applic to register and handle LoraWAN to MBMUX
  - LoRaWAN_End_Node_DualCoreFreeRTOS/CM0PLUS/MbMux/mbmuxif_radio.c             allows CM0PLUS applic to register and handle RADIO driver via MBMUX
  - LoRaWAN_End_Node_DualCoreFreeRTOS/CM0PLUS/MbMux/mbmuxif_sys.c               allows CM0 applic to handle the SYSTEM MBMUX channel
  ...
  - LoRaWAN_End_Node_DualCoreFreeRTOS/CM4/Core/Src/ipcc.c                       This file provides code for the configuration
                                                                                of the IPCC instances.
  - LoRaWAN_End_Node_DualCoreFreeRTOS/CM4/Core/Src/ipcc_if.c                    Interface to IPCC: handles IRQs and abstract appl from Ipcc handler and ch direction
  ...
  - LoRaWAN_End_Node_DualCoreFreeRTOS/CM4/Core/Src/usart_if.c                   Configuration of UART MX driver interface for hyperterminal communication
  ...
  - LoRaWAN_End_Node_DualCoreFreeRTOS/CM4/MbMux/mbmuxif_kms.c                   Interface layer CM4 Kms to MBMUX (Mailbox Multiplexer)
  - LoRaWAN_End_Node_DualCoreFreeRTOS/CM4/MbMux/mbmuxif_lora.c                  allows CM4 applic to register and handle LoraWAN via MBMUX
  - LoRaWAN_End_Node_DualCoreFreeRTOS/CM4/MbMux/mbmuxif_radio.c                 allows CM4 applic to register and handle RADIO driver via MBMUX
  - LoRaWAN_End_Node_DualCoreFreeRTOS/CM4/MbMux/mbmuxif_sys.c                   allows CM4 applic to handle the SYSTEM MBMUX channel.
  - LoRaWAN_End_Node_DualCoreFreeRTOS/CM4/MbMux/mbmuxif_trace.c                 allows CM4 applic to receive by CM0 TRACE via MBMUX
  - LoRaWAN_End_Node_DualCoreFreeRTOS/CM4/MbMux/radio_mbwrapper.c               This file implements the CM4 side wrapper of the Radio interface
                                                                                shared between M0 and M4.
  - LoRaWAN_End_Node_DualCoreFreeRTOS/Common/Board/board_resources.c            Source file
