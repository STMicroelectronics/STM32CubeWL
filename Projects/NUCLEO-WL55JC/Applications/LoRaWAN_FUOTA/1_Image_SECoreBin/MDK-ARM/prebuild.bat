...
set "kmsblob_ecckey=%SBSFUBootLoader%\\1_Image_KMS_Blob\\Binary\\ECCKEY.txt"
...
%command%
IF %ERRORLEVEL% NEQ 0 goto error
set "kmsblob_oemkey=%SBSFUBootLoader%\\1_Image_KMS_Blob\\Binary\\OEM_KEY_COMPANY1_key_AES_CBC.bin"
