...
#define SLOT_ACTIVE_1_START          0x08022000
#define SLOT_ACTIVE_1_END            0x0802FFFF

/* Active slot #2  (60 kbytes) */
#define SLOT_ACTIVE_2_HEADER         0x0803F000
#define SLOT_ACTIVE_2_START          0x08012000
#define SLOT_ACTIVE_2_END            0x08020FFF

/* Dwl slot #1  (60 kbytes) */
#define SLOT_DWL_1_START             0x08003000
#define SLOT_DWL_1_END               0x08011FFF
