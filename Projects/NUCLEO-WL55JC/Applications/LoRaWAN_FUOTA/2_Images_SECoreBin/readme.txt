...
This example supports multiple images feature configured with 2 active images for execution from internal flash and 1
download area also located in internal flash. Each image has its own keys for signature verification and firwmare encryption.
...
@par Directory contents
   ...
   - 2_Images_SECoreBin/Binary/ECCKEY3.txt                      Private ECCDSA key for signature verification of a possible 3rd active image
   ...
   - 2_Images_SECoreBin/Binary/OEM_KEY_COMPANY3_key_AES_CBC.bin Public key for AES CBC encryption of a possible 3rd active image
   - 2_Images_SECoreBin/Binary/OEM_KEY_COMPANY3_key_AES_GCM.bin Public key for AES GCM encryption of a possible 3rd active image
...
This preliminary processing is in charge of:
 ...
 - generating the appropriate keys in <IDE folder>/kms_platf_objects_config.h (from injection of SBSFU & Blob importation keys into the KMS embedded objects pattern file)
