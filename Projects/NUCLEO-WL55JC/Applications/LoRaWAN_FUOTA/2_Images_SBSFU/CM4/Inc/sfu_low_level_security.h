...
#define SFU_C2_PROTECT_WRP_PAGE_START      ((uint32_t)((SFU_C2_BOOT_BASE_ADDR - FLASH_BASE) / FLASH_PAGE_SIZE))

/*!< Last page: (code_size-1)/page_size because the page
     indexes start from 0 */
#define SFU_C2_PROTECT_WRP_PAGE_END        ((uint32_t)((SFU_C2_AREA_ADDR_END - FLASH_BASE) / FLASH_PAGE_SIZE))
...
/**
  ...
  *                   From 0x08012000 ==> 0x0801FFFF (56 kbytes)
  */
#define SFU_PROTECT_MPU_APP_FLASHEXE_RGNV  MPU_REGION_NUMBER3
#define SFU_PROTECT_MPU_APP_FLASHEXE_START 0x08012000UL
#define SFU_PROTECT_MPU_APP_FLASHEXE_SIZE  MPU_REGION_SIZE_64KB
#define SFU_PROTECT_MPU_APP_FLASHEXE_SREG  0x01U    /*!< 64 Kbytes / 8 * 7 ==> 56 Kbytes */
...
/**
  ...
  *                   In addition to region 3, from 0x08020000 ==> 0x08020FFF (4 kbytes)
  */
#define SFU_PROTECT_MPU_APP_FLASHEXE_ADJUST_RGNV  MPU_REGION_NUMBER4
#define SFU_PROTECT_MPU_APP_FLASHEXE_ADJUST_START 0x08020000UL
#define SFU_PROTECT_MPU_APP_FLASHEXE_ADJUST_SIZE  MPU_REGION_SIZE_4KB
#define SFU_PROTECT_MPU_APP_FLASHEXE_ADJUST_SREG  0x00U                /*!< All subregions activated */
...
/**
  * @brief Region 3 - Enable the execution for the active slot in unprivileged mode.
  *                   Read only capability configured
  *                   From 0x08012000 ==> 0x0801FFFF (56 kbytes)
  */
#define APP_PROTECT_MPU_FLASHEXE_RGNV  MPU_REGION_NUMBER3
#define APP_PROTECT_MPU_FLASHEXE_START 0x08012000UL
#define APP_PROTECT_MPU_FLASHEXE_SIZE  MPU_REGION_SIZE_64KB
#define APP_PROTECT_MPU_FLASHEXE_SREG  0x01U    /*!< 64 Kbytes / 8 * 7 ==> 56 Kbytes */
...
#define APP_PROTECT_MPU_FLASHEXE_ADJUST_START 0x08020000UL
#define APP_PROTECT_MPU_FLASHEXE_ADJUST_SIZE  MPU_REGION_SIZE_4KB
#define APP_PROTECT_MPU_FLASHEXE_ADJUST_SREG  0x00U                /*!< All subregions activated */
