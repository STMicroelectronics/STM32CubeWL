...
/**
  ...
  *                   From 0x08030000 ==> 0x0803FFFF
  */
#define SFU_PROTECT_MPU_FLASHEXE_RGNV  MPU_REGION_NUMBER2
#define SFU_PROTECT_MPU_FLASHEXE_START 0x08030000UL
#define SFU_PROTECT_MPU_FLASHEXE_SIZE  MPU_REGION_SIZE_64KB
...
#define SFU_PROTECT_MPU_KMS_SIZE  MPU_REGION_SIZE_4KB
...
/**
  ...
  *                   From 0x08012000 ==> 0x08017FFF (24 kbytes)
  */
#define APP_PROTECT_MPU_FLASHEXE_1_RGNV  MPU_REGION_NUMBER2
#define APP_PROTECT_MPU_FLASHEXE_1_START 0x08010000UL
#define APP_PROTECT_MPU_FLASHEXE_1_SIZE  MPU_REGION_SIZE_32KB
#define APP_PROTECT_MPU_FLASHEXE_1_SREG  0x03U               /*!< 32 Kbytes / 8 * 6 ==> 24 Kbytes */
...
#define APP_PROTECT_MPU_FLASHEXE_1_B     MPU_ACCESS_BUFFERABLE
#define APP_PROTECT_MPU_FLASHEXE_1_C     MPU_ACCESS_NOT_CACHEABLE

/**
  * @brief Region 3 - Enable the execution for the SBSFU and active slots in unprivileged mode.
  *                   Read only capability configured
  *                   Execution capability enabled
  *                   Execution capability restricted by other regions (MPU and secure)
  *                   From 0x08018000 ==> 0x0803FFFF (160 kbytes)
  */
#define APP_PROTECT_MPU_FLASHEXE_2_RGNV  MPU_REGION_NUMBER3
#define APP_PROTECT_MPU_FLASHEXE_2_START FLASH_BASE          /*!< FLASH memory area */
#define APP_PROTECT_MPU_FLASHEXE_2_SIZE  MPU_REGION_SIZE_256KB
#define APP_PROTECT_MPU_FLASHEXE_2_SREG  0x07U               /*!< 256 Kbytes / 8 * 5 ==> 160 Kbytes */
#define APP_PROTECT_MPU_FLASHEXE_2_PERM  MPU_REGION_PRIV_RO_URO
#define APP_PROTECT_MPU_FLASHEXE_2_EXECV MPU_INSTRUCTION_ACCESS_ENABLE
#define APP_PROTECT_MPU_FLASHEXE_2_TEXV  MPU_TEX_LEVEL0
#define APP_PROTECT_MPU_FLASHEXE_2_B     MPU_ACCESS_BUFFERABLE
#define APP_PROTECT_MPU_FLASHEXE_2_C     MPU_ACCESS_NOT_CACHEABLE
...
#define APP_PROTECT_MPU_SRAM_FLAG_START M4_M0PLUS_FLAG_RAM_START /*!< SBSFU synchronization flag */
#define APP_PROTECT_MPU_SRAM_FLAG_SIZE  MPU_REGION_SIZE_32B
#define APP_PROTECT_MPU_SRAM_FLAG_SREG  0x00U                /*!< All subregions activated */
