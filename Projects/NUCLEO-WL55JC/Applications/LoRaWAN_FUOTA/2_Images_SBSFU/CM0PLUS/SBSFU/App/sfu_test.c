...
static ProtectionTest_t aProtectTests[] =
{
   ...
   * 0x1FFF 7870 User option bytes (USER)
   * 0x1FFF 7878 User option bytes (USER)
   */
  {(uint32_t)0x1FFF7800, "OBs @ 0x1FFFC000", TEST_WRITE_FLASH},
  {(uint32_t)0x1FFF7818, "OBs @ 0x1FFFC008", TEST_WRITE_FLASH},
  {(uint32_t)0x1FFF7820, "OBs @ 0x1FFFC008", TEST_WRITE_FLASH},
  {(uint32_t)0x1FFF7870, "OBs @ 0x1FFFC008", TEST_WRITE_FLASH},
  {(uint32_t)0x1FFF7878, "OBs @ 0x1FFFC008", TEST_WRITE_FLASH},
#endif /* SFU_MPU_PROTECT_ENABLE  */
