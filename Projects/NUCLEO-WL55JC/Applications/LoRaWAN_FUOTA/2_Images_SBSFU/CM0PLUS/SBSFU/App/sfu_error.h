...
typedef enum
{
  ...
  SFU_EXCPT_INSTALL_NEW_USER_FW_ERR,
  SFU_EXCPT_VERIFY_USER_FW_SIGNATURE_ERR,
  SFU_EXCPT_RESUME_INSTALL_NEW_USER_FW_ERR,
  ...
  SFU_EXCPT_FWIMG_SWAP,            /* Problem while swapping the images */
  SFU_EXCPT_FWIMG_ROLLBACK,        /* Problem during rollback process */
  SFU_EXCPT_FWIMG_ROLLBACK_PREV_ID,/* Backed-up firmware not identified */
