...
echo ###########################################
call :compile_func %current_dir%..\..\LoRaWAN_End_Node_DualCore\EWARM\LoRaWAN_End_Node_DualCore_CM0PLUS.ewp || goto :eof
call :compile_func %current_dir%..\..\LoRaWAN_End_Node_DualCore\EWARM\LoRaWAN_End_Node_DualCore_CM4.ewp || goto :eof
