...
call :compile_func %current_dir%..\..\LoRaWAN_End_Node_DualCore\MDK-ARM\LoRaWAN_End_Node_DualCore_CM0PLUS.uvprojx || goto :eof
echo Build LoRaWAN_End_Node_DualCore\CM4
call :compile_func %current_dir%..\..\LoRaWAN_End_Node_DualCore\MDK-ARM\LoRaWAN_End_Node_DualCore_CM4.uvprojx || goto :eof
