...
set "workspacedir=%current_dir%..\..\LoRaWAN_End_Node_DualCore\STM32CubeIDE\Binary\ws"
...
echo ###########################################
call :compile_func %current_dir%..\..\LoRaWAN_End_Node_DualCore\STM32CubeIDE\CM0PLUS || goto :eof
call :compile_func %current_dir%..\..\LoRaWAN_End_Node_DualCore\STM32CubeIDE\CM4 || goto :eof
