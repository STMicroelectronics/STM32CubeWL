...
/**
  ******************************************************************************
  * @file    PWR/PWR_Stop2_PeripheralNoRetention/Src/main.c
  * @author  MCD Application Team
  * @brief   This example describes how to use low-power mode Stop2 
  *          and peripherals not featuring retention of configuration.
  ******************************************************************************
  * @attention
  *
