...
/**
  ******************************************************************************
  * @file    HSEM/HSEM_Sync_DualCore/CM4/Src/main.c
...
int main(void)
{
  ...
  /* Initialize the LEDs used by CPU1 */
  BSP_LED_Init(LED1);
  BSP_LED_Init(LED3);
  ...
  {
    /* Emulation of CPU1 Process1 execution start: Turn on LED1 */
    BSP_LED_On(LED1);
  }
  else
  {
  ...
  /* Emulation of CPU1 Process1 execution end: Turn off LED1 */
  BSP_LED_Off(LED1);
