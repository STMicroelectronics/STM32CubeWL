...
# Registers execution platforms so that they can be used in the build. This
# must be done before the toolchain is instantiated.
register_execution_platforms(
    "//:stm32wl55xx_cortex_m0",
    "//:stm32wl55xx_cortex_m4",
    "//:stm32wl54xx_cortex_m0",
    "//:stm32wl54xx_cortex_m4",
    "//:stm32wle5xx_cortex_m4",
    "//:stm32wle4xx_cortex_m4",
)
